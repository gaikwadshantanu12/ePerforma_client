...
class ViewOfficialNotices extends StatefulWidget {
  const ViewOfficialNotices({super.key});

  @override
  State<ViewOfficialNotices> createState() => _ViewOfficialNoticesState();
}

class _ViewOfficialNoticesState extends State<ViewOfficialNotices> {
  ...
  void _fetchData() {
    TeachersMiddleWare.fetchNoticesByDepartment(_teacher.teacherDepartment)
        .then((noticesList) {
      setState(() {
      ...
      body: isLoading
          ...
          : _notices.isEmpty
              ? DefaultAnimationMessage(
                  ...
                  animationMessage:
                      "Oopps !!! No notices sent found for students of ${_teacher.teacherDepartment}. ",
