...
class ViewBatchStudents extends StatefulWidget {
  const ViewBatchStudents({super.key});

  @override
  State<ViewBatchStudents> createState() => _ViewBatchStudentsState();
}

class _ViewBatchStudentsState extends State<ViewBatchStudents> {
  ...
  void _fetchData() {
    TeachersMiddleWare.fetchStudentsByBatch(
      _batchDetails.department,
      _batchDetails.year,
      _batchDetails.section,
      _batchDetails.startingRollNo.toString(),
      _batchDetails.endingRollNo.toString(),
    ).then((studentsList) {
      setState(() {
      ...
      body: isLoading
          ...
          : _students.isEmpty
              ? DefaultAnimationMessage(
                  ...
                  animationMessage:
                      "Oopps !!! No students found for ${_batchDetails.year} - ${_batchDetails.section} (${_batchDetails.startingRollNo} - ${_batchDetails.endingRollNo}) division students.",
